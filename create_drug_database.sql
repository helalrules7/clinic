...
-- ملاحظة: يجب استبدال المسار بمسار الملف الصحيح
LOAD DATA INFILE 'drugs_export.csv'
INTO TABLE drugs
...
CREATE USER IF NOT EXISTS 'drug_user'@'localhost' IDENTIFIED BY 'drug_password';
