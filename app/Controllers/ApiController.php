...
class ApiController
{
    ...
    public function createLabTest(...$params)
    {
        try {
    ...
    /**
     * Get common complaints from cached JSON file and merge with seed data
     * Route: GET /api/consultation/common-complaints
     */
    public function getCommonComplaints()
    {
        try {
            ...
            foreach ($seedData as $seedComplaint) {
                if (!isset($seedComplaint['complaint'])) continue;
