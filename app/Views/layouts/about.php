        ...
        <div class="col-12">
            <div class="card border-0 bg-gradient" style="background: linear-gradient(135deg, var(--accent), var(--success));">
                <div class="card-body text-white text-center py-5 header-content">
                    ...
                    <h1 class="display-4 fw-bold mb-3">HClinic / Roaya Clinic</h1>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="info-item mb-4">
                                ...
                                <p class="h4 text-primary fw-bold">5.1</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-item mb-4">
            ...
            <div class="card border-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-4 mb-4">
                            <div class="new-feature-card text-center p-4 border rounded">
                                <div class="new-feature-icon bg-info text-white rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center" style="width: 60px; height: 60px; background-color: #06b6d4 !important;">
                                    <i class="bi bi-calendar-check" style="font-size: 1.5rem;"></i>
                                </div>
                                <h5 class="fw-bold mb-3">Appointment History Timeline</h5>
                                <p class="text-muted mb-0">Comprehensive appointment history with timeline view, showing all patient visits, prescriptions, attachments, and consultation notes in a beautiful chronological format.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 mb-4">
                            <div class="new-feature-card text-center p-4 border rounded">
                                <div class="new-feature-icon bg-success text-white rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center" style="width: 60px; height: 60px; background-color: #10b981 !important;">
                                    <i class="bi bi-image" style="font-size: 1.5rem;"></i>
                                </div>
                                <h5 class="fw-bold mb-3">Attachment Thumbnails</h5>
                                <p class="text-muted mb-0">Visual attachment management with thumbnail previews in appointment history, clickable image modals, and seamless file viewing experience with dark mode support.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 mb-4">
                            <div class="new-feature-card text-center p-4 border rounded">
                                <div class="new-feature-icon bg-danger text-white rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center" style="width: 60px; height: 60px; background-color: #ef4444 !important;">
                                    <i class="bi bi-exclamation-triangle" style="font-size: 1.5rem;"></i>
                                </div>
                                <h5 class="fw-bold mb-3">Missed Appointments Tracking</h5>
                                <p class="text-muted mb-0">Advanced missed appointments section with pagination, quantity control, and one-click completion marking with confirmation modals for better appointment management.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4 mb-4">
                            <div class="new-feature-card text-center p-4 border rounded">
                                <div class="new-feature-icon bg-primary text-white rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center" style="width: 60px; height: 60px; background-color: #3b82f6 !important;">
                                    <i class="bi bi-graph-up" style="font-size: 1.5rem;"></i>
                                </div>
                                <h5 class="fw-bold mb-3">Visual Analytics Dashboard</h5>
                                <p class="text-muted mb-0">Interactive charts with Chart.js showing appointment trends, status distribution, and comprehensive statistics with dark mode support and real-time data visualization.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 mb-4">
                            <div class="new-feature-card text-center p-4 border rounded">
                                <div class="new-feature-icon bg-warning text-white rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center" style="width: 60px; height: 60px; background-color: #f59e0b !important;">
                                    <i class="bi bi-table" style="font-size: 1.5rem;"></i>
                                </div>
                                <h5 class="fw-bold mb-3">Statistics Dashboard</h5>
                                <p class="text-muted mb-0">Comprehensive statistics table showing all appointments, completed appointments, missed appointments, and completion ratio with dark mode styling and accurate calculations.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 mb-4">
                            <div class="new-feature-card text-center p-4 border rounded">
                                ...
                                <h5 class="fw-bold mb-3">Advanced Pagination System</h5>
                                <p class="text-muted mb-0">Smart pagination with quantity control for upcoming appointments and recent activity, using AJAX for dynamic loading and seamless user experience.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="alert alert-primary border-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h6 class="alert-heading mb-1">Major Dashboard & Patient Management Enhancement</h6>
                                        <p class="mb-0">Version 5.0 brings revolutionary improvements to dashboard analytics, appointment history visualization, attachment management, and comprehensive statistics tracking for enhanced clinic management and patient care.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="alert alert-success border-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0">Version 5.0 introduces comprehensive dashboard analytics, appointment history timeline, visual attachment management, missed appointments tracking, and advanced statistics with dark mode support for enhanced clinic management and patient care.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="timeline">
                        <div class="timeline-item mb-4">
                            <div class="d-flex">
                                <div class="timeline-marker bg-primary text-white rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 30px; height: 30px; min-width: 30px; background-color: #3b82f6 !important;">
                                    <i class="bi bi-database" style="font-size: 0.8rem;"></i>
                                </div>
                                <div>
                                    <h6 class="fw-bold mb-1">Automatic Drug Database Update System</h6>
                                    <p class="text-muted mb-0">Complete automated drug database update system with direct integration from official sources. Features intelligent column mapping, SQLite database support, progress tracking, and seamless integration from both drugs search page and system settings for always up-to-date drug information.</p>
                                </div>
                            </div>
                        </div>
                        <div class="timeline-item mb-4">
                            <div class="d-flex">
                                <div class="timeline-marker bg-success text-white rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 30px; height: 30px; min-width: 30px; background-color: #10b981 !important;">
                                    <i class="bi bi-arrow-repeat" style="font-size: 0.8rem;"></i>
                                </div>
                                <div>
                                    <h6 class="fw-bold mb-1">Real-time Database Synchronization</h6>
                                    <p class="text-muted mb-0">Advanced database synchronization with comprehensive progress tracking, detailed error handling, transaction rollback support, and complete statistics reporting. Update your drug database with a single click and monitor the entire process in real-time.</p>
                                </div>
                            </div>
                        </div>
                        <div class="timeline-item mb-4">
                            <div class="d-flex">
                                <div class="timeline-marker bg-warning text-white rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 30px; height: 30px; min-width: 30px; background-color: #f59e0b !important;">
                                    <i class="bi bi-tools" style="font-size: 0.8rem;"></i>
                                </div>
                                <div>
                                    <h6 class="fw-bold mb-1">SQLite Command-Line Integration</h6>
                                    <p class="text-muted mb-0">Robust SQLite database processing using command-line tools with automatic executable path detection, intelligent fallback mechanisms, comprehensive error handling, and maximum server compatibility for seamless database operations.</p>
                                </div>
                            </div>
                        </div>
                        <div class="timeline-item mb-4">
                            <div class="d-flex">
                                <div class="timeline-marker bg-danger text-white rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 30px; height: 30px; min-width: 30px; background-color: #ef4444 !important;">
                                    <i class="bi bi-shield-check" style="font-size: 0.8rem;"></i>
                                </div>
                                <div>
                                    <h6 class="fw-bold mb-1">Enhanced Error Handling & Logging</h6>
                                    <p class="text-muted mb-0">Comprehensive error handling system with detailed logging, automatic transaction rollback on failures, user-friendly error messages, and complete debugging information for reliable database update operations.</p>
                                </div>
                            </div>
                        </div>
                        <div class="timeline-item mb-4">
                            <div class="d-flex">
                                <div class="timeline-marker bg-info text-white rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 30px; height: 30px; min-width: 30px; background-color: #06b6d4 !important;">
                                    <i class="bi bi-calendar-check" style="font-size: 0.8rem;"></i>
                                </div>
                                <div>
                                    <h6 class="fw-bold mb-1">Appointment History Timeline</h6>
                                    <p class="text-muted mb-0">Comprehensive appointment history with beautiful timeline view, showing all patient visits, medications, glasses prescriptions, attachments, and consultation notes in chronological format with dark mode support.</p>
                                </div>
                            </div>
                        </div>
                        <div class="timeline-item mb-4">
                            <div class="d-flex">
                                ...
                                <div>
                                    <h6 class="fw-bold mb-1">Attachment Thumbnails in Appointment History</h6>
                                    <p class="text-muted mb-0">Visual attachment management with thumbnail previews directly in appointment history timeline, clickable image modals, and seamless file viewing experience with full dark mode support.</p>
                                </div>
                            </div>
                        </div>
                        <div class="timeline-item mb-4">
                            <div class="d-flex">
                                ...
                                <div>
                                    <h6 class="fw-bold mb-1">Missed Appointments Management</h6>
                                    <p class="text-muted mb-0">Advanced missed appointments section with pagination, quantity control (5, 10, 20, 50 per page), one-click completion marking with confirmation modals, and comprehensive tracking for better appointment management.</p>
                                </div>
                            </div>
                        </div>
                        <div class="timeline-item mb-4">
                            <div class="d-flex">
                                ...
                                <div>
                                    <h6 class="fw-bold mb-1">Visual Analytics Dashboard</h6>
                                    <p class="text-muted mb-0">Interactive charts with Chart.js showing appointment trends (line chart) and status distribution (doughnut chart) with dark mode support, white text, and real-time data visualization for comprehensive analytics.</p>
                                </div>
                            </div>
                        </div>
                        <div class="timeline-item mb-4">
                            <div class="d-flex">
                                ...
                                <div>
                                    <h6 class="fw-bold mb-1">Statistics Dashboard Table</h6>
                                    <p class="text-muted mb-0">Comprehensive statistics table showing all appointments, completed appointments, missed appointments, and completion ratio with accurate calculations excluding today's appointments and full dark mode styling.</p>
                                </div>
                            </div>
                        </div>
                        <div class="timeline-item mb-4">
                            <div class="d-flex">
                                ...
                                <div>
                                    <h6 class="fw-bold mb-1">Advanced Pagination & Quantity Control</h6>
                                    <p class="text-muted mb-0">Smart pagination system with quantity control for upcoming appointments and recent activity sections, using AJAX for dynamic loading, seamless user experience, and responsive design.</p>
                                </div>
                            </div>
                        </div>
                        <div class="timeline-item mb-4">
                            <div class="d-flex">
                                ...
                                <div>
                                    <h6 class="fw-bold mb-1">Mark as Completed Modal</h6>
                                    <p class="text-muted mb-0">Enhanced appointment completion workflow with confirmation modals, direct status updates, and seamless page refresh for better appointment management and user experience.</p>
                                </div>
                            </div>
                        </div>
                        <div class="timeline-item mb-4">
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-4">
                            <div class="new-feature-card text-center p-4 border rounded">
                                ...
                                <h5 class="fw-bold mb-3">Automatic Drug Database Update</h5>
                                <p class="text-muted mb-0">Complete automated drug database update system with direct integration from official sources, supporting SQLite database format with intelligent column mapping and data synchronization.</p>
                            </div>
                        </div>
                        <div class="col-lg-6 mb-4">
                            <div class="new-feature-card text-center p-4 border rounded">
                                ...
                                <h5 class="fw-bold mb-3">Real-time Database Synchronization</h5>
                                <p class="text-muted mb-0">Advanced database synchronization with progress tracking, error handling, and comprehensive statistics. Update your drug database with a single click from both drugs page and settings page.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-lg-6 mb-4">
                            <div class="new-feature-card text-center p-4 border rounded">
                                ...
                                <h5 class="fw-bold mb-3">SQLite Command-Line Integration</h5>
                                <p class="text-muted mb-0">Robust SQLite database processing using command-line tools with automatic path detection, fallback mechanisms, and comprehensive error handling for maximum compatibility.</p>
                            </div>
                        </div>
                        <div class="col-lg-6 mb-4">
                            <div class="new-feature-card text-center p-4 border rounded">
                                ...
                                <h5 class="fw-bold mb-3">Enhanced Error Handling</h5>
                                <p class="text-muted mb-0">Comprehensive error handling with detailed logging, transaction rollback support, and user-friendly error messages for seamless database update experience.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="alert alert-info border-0">
                                <div class="d-flex align-items-center">
                                    <i class="bi bi-lightbulb text-info me-3" style="font-size: 1.5rem;"></i>
                                    <div>
                                        <h6 class="alert-heading mb-1">Revolutionary Drug Database Management</h6>
                                        <p class="mb-0">Version 5.1 introduces a complete automated drug database update system with intelligent column mapping, SQLite support, progress tracking, and seamless integration from both the drugs search page and system settings. This ensures your drug database is always up-to-date with the latest information from official sources.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
