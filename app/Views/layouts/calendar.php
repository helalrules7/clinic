...
function renderAppointmentSlot(appointment) {
        ...
        <div class="appointment-tooltip">
            ...
            <div class="tooltip-body">
                ...
                <div class="tooltip-row">
                    ...
                    <span class="tooltip-value">${appointment.clinic_name_ar || appointment.clinic_name_en || 'N/A'}</span>
                </div>
                <div class="tooltip-row">
    ...
    const clinicLabel = appointment.clinic_name_ar || appointment.clinic_name_en || '';
        ...
        <div class="appointment-card ${appointment.status.toLowerCase()}"
            ...
            <div class="appointment-header">
                <div class="appointment-info" onclick="navigateToAppointment(${appointment.id})">
                    ...
                    ${clinicLabel ? `<div class="info-line"><span class="label">Clinic:</span> <span class="clinic-tag"><i class="bi bi-building"></i> ${clinicLabel}</span></div>` : ''}
...
function handleAddAppointment(e) {
    ...
    if (!appointmentData.clinic_id) {
        showErrorMessage('Please select a clinic');
        return;
    }
