                ...
                <div className="mb-8 space-y-6">
                    ...
                    <div className="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 border border-indigo-200 dark:border-indigo-800 rounded-xl p-6">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-gray-900 dark:text-white">
                                    {t('sections.home.whats_new.v8_0_0.ai_assistant.title')}
                                </h3>
                            </div>
                        </div>
                        <p className="text-gray-700 dark:text-gray-300 mb-4">
                            {t('sections.home.whats_new.v8_0_0.ai_assistant.description')}
                        </p>
                        <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300 mb-6">
                            <li className="flex items-start gap-2">
                                <span className="text-indigo-500 mt-1">•</span>
                                <span>{t('sections.home.whats_new.v8_0_0.ai_assistant.features.history_analysis')}</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-indigo-500 mt-1">•</span>
                                <span>{t('sections.home.whats_new.v8_0_0.ai_assistant.features.consultation_summary')}</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-indigo-500 mt-1">•</span>
                                <span>{t('sections.home.whats_new.v8_0_0.ai_assistant.features.medical_guidance')}</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-indigo-500 mt-1">•</span>
                                <span>{t('sections.home.whats_new.v8_0_0.ai_assistant.features.chat_history')}</span>
                            </li>
                        </ul>
                    ...
                    <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border border-purple-200 dark:border-purple-800 rounded-xl p-6">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-gray-900 dark:text-white">
                                    {t('sections.home.whats_new.v8_0_0.common_complaints.title')}
                                </h3>
                            </div>
                        </div>
                        <p className="text-gray-700 dark:text-gray-300 mb-4">
                            {t('sections.home.whats_new.v8_0_0.common_complaints.description')}
                        </p>
                        <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300 mb-6">
                            <li className="flex items-start gap-2">
                                <span className="text-purple-500 mt-1">•</span>
                                <span>{t('sections.home.whats_new.v8_0_0.common_complaints.features.extraction')}</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-purple-500 mt-1">•</span>
                                <span>{t('sections.home.whats_new.v8_0_0.common_complaints.features.quick_selection')}</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-purple-500 mt-1">•</span>
                                <span>{t('sections.home.whats_new.v8_0_0.common_complaints.features.autocomplete')}</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-purple-500 mt-1">•</span>
                                <span>{t('sections.home.whats_new.v8_0_0.common_complaints.features.prescription_suggestions')}</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-purple-500 mt-1">•</span>
                                <span>{t('sections.home.whats_new.v8_0_0.common_complaints.features.auto_updates')}</span>
                            </li>
                        </ul>
                    ...
                    <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-800 rounded-xl p-6">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-gray-900 dark:text-white">
                                    {t('sections.home.whats_new.v8_0_0.patient_enhancements.title')}
                                </h3>
                            </div>
                        </div>
                        <p className="text-gray-700 dark:text-gray-300 mb-4">
                            {t('sections.home.whats_new.v8_0_0.patient_enhancements.description')}
                        </p>
                        <div className="space-y-4 mb-6">
                            <div className="bg-white/50 dark:bg-slate-800/50 rounded-lg p-4 border-l-4 border-green-500">
                                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">
                                    {t('sections.home.whats_new.v8_0_0.patient_enhancements.phone_validation.title')}
                                </h4>
                                <p className="text-sm text-gray-700 dark:text-gray-300">
                                    {t('sections.home.whats_new.v8_0_0.patient_enhancements.phone_validation.description')}
                                </p>
                            </div>
                            <div className="bg-white/50 dark:bg-slate-800/50 rounded-lg p-4 border-l-4 border-green-500">
                                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">
                                    {t('sections.home.whats_new.v8_0_0.patient_enhancements.copy_phone.title')}
                                </h4>
                                <p className="text-sm text-gray-700 dark:text-gray-300">
                                    {t('sections.home.whats_new.v8_0_0.patient_enhancements.copy_phone.description')}
                                </p>
                            </div>
                        </div>
                    ...
                    {/* System Fixes Feature */}
                    <div className="bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 border border-orange-200 dark:border-orange-800 rounded-xl p-6">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-gray-900 dark:text-white">
                                    {t('sections.home.whats_new.v8_0_0.fixes.title')}
                                </h3>
                            </div>
                        </div>
                        <p className="text-gray-700 dark:text-gray-300 mb-4">
                            {t('sections.home.whats_new.v8_0_0.fixes.description')}
                        </p>
                        <div className="space-y-3">
                            <div className="bg-white/50 dark:bg-slate-800/50 rounded-lg p-4 border-l-4 border-orange-500">
                                <h4 className="font-semibold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                                    <span className="text-green-500">✓</span>
                                    {t('sections.home.whats_new.v8_0_0.fixes.lab_tests')}
                                </h4>
                                <p className="text-sm text-gray-700 dark:text-gray-300">
                                    {t('sections.home.whats_new.v8_0_0.fixes.lab_tests_desc')}
                                </p>
                            </div>
                            <div className="bg-white/50 dark:bg-slate-800/50 rounded-lg p-4 border-l-4 border-orange-500">
                                <h4 className="font-semibold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                                    <span className="text-green-500">✓</span>
                                    {t('sections.home.whats_new.v8_0_0.fixes.modals')}
                                </h4>
                                <p className="text-sm text-gray-700 dark:text-gray-300">
                                    {t('sections.home.whats_new.v8_0_0.fixes.modals_desc')}
                                </p>
                            </div>
                            <div className="bg-white/50 dark:bg-slate-800/50 rounded-lg p-4 border-l-4 border-orange-500">
                                <h4 className="font-semibold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                                    <span className="text-green-500">✓</span>
                                    {t('sections.home.whats_new.v8_0_0.fixes.dark_mode')}
                                </h4>
                                <p className="text-sm text-gray-700 dark:text-gray-300">
                                    {t('sections.home.whats_new.v8_0_0.fixes.dark_mode_desc')}
                                </p>
                            </div>
                            <div className="bg-white/50 dark:bg-slate-800/50 rounded-lg p-4 border-l-4 border-orange-500">
                                <h4 className="font-semibold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                                    <span className="text-green-500">✓</span>
                                    {t('sections.home.whats_new.v8_0_0.fixes.z_index')}
                                </h4>
                                <p className="text-sm text-gray-700 dark:text-gray-300">
                                    {t('sections.home.whats_new.v8_0_0.fixes.z_index_desc')}
                                </p>
                            </div>
                        </div>
                    </div>
