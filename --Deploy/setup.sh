...
DB_HOST=localhost
DB_NAME=hclinic_roaya
DB_USER=hclinic_roaya
DB_PASS=Carmen@1230
...
echo "- قاعدة البيانات: hclinic_roaya"
echo "- المستخدم: hclinic_roaya"
echo "- البيئة: production"
echo ""
echo "🔗 اختبر الموقع:"
echo "- https://roaya.hclinic.clinic/"
echo "- https://roaya.hclinic.clinic/login"
echo ""
echo "📊 إذا لم يعمل، تحقق من:"
echo "- tail -f /home/hclinic/web/roaya.hclinic.clinic/logs/roaya.hclinic.clinic.error.log"
